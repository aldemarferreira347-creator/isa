...
const GUION = {
  ...
  capitulos: {
    ...
    // ── Capítulo 2 — Los domingos (islas al atardecer) ──
    tarde: {
      titulo: "Los domingos",
      fecha: "la distancia",
      inicio: [
        "Después vinieron los domingos — el único día de la semana que de verdad era nuestro.",
        "El resto de los días la pantalla ayudaba, pero nunca alcanzaba del todo."
      ],
      final: [
        "Cada isla de este camino fue un domingo esperado toda la semana.",
      ...
      coleccionables: [
        ...
        "Aprendí a querer los domingos más que a cualquier otro día de la semana.",
        "Esperar también fue una manera de quererte — sólo que en silencio.",
        "Y cada domingo que llegaba, el mundo volvía a florecer un poco."
      ]
    },
  ...
  jefe: {
    ...
    // Al completar los corazones con la batalla aún en marcha: el portal
    // no puede abrirse todavía, y hay que decir por qué.
    corazonesListos: "Ya están todos los corazones — pero el portal no se abre hasta cerrar esa grieta.",
  ...
  cartaFinal: {
    ...
    parrafos: [
      ...
      "Pero ningún tropiezo fue nunca razón para dejar de caminar hacia ti. Ni la distancia de los domingos, ni la pantalla, ni el miedo de aquel 10 de abril.",
